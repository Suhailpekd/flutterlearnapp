...
class Navigations1 extends StatefulWidget {
  const Navigations1({super.key});

  @override
  State<Navigations1> createState() => _WhatisdartState();
}

class _WhatisdartState extends State<Navigations1> {
  @override
